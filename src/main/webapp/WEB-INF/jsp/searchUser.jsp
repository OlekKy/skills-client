...
<body>
	<section>
		<div class="jumbotron">
			<div class="container">
				<h1>Search</h1>
				<p>All user details by User ID</p>
			</div>	
		</div>
	</section>
	<section class="container">
		<form:form  modelAttribute="userFullDTO" class="form-horizontal">
			<fieldset>

				<div class="form-group">
					<label class="control-label col-lg-2" for="id">Enter User ID</label>
					<div class="col-lg-10">
